    ...
    <div className="p-6 h-full flex flex-col bg-slate-50">
      ...
      <div className="flex justify-between items-center mb-6 shrink-0">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => openModal()} className="px-4 py-2 bg-[#D4AF37] hover:bg-[#B8860B] text-white rounded-xl font-bold flex items-center gap-2 shadow-sm hover-lift">
      ...
      {editingItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div 
            className="bg-white rounded-squircle-2xl w-full max-w-lg relative z-10 flex flex-col"
