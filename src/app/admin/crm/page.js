        ...
        <div style={{ paddingTop: `${topHeight}px` }} className="px-4 md:px-8 pb-24 w-full flex flex-col">
          {activeTab === "clinicas" ? (
            loading && clientes.length === 0 ? (
               ...
               <div key={c.id} className="relative group border-b border-slate-300">
                 {/* La línea horizontal que sale del cuadro hacia los lados */}
                 <div className="absolute bottom-[-1px] left-[-100vw] right-[-100vw] h-[1px] bg-slate-300 pointer-events-none z-0"></div>
            ...
            loading && doctores.length === 0 ? (
               ...
               <div key={d.id} className="relative group border-b border-slate-300">
                 {/* La línea horizontal que sale del cuadro hacia los lados */}
                 <div className="absolute bottom-[-1px] left-[-100vw] right-[-100vw] h-[1px] bg-slate-300 pointer-events-none z-0"></div>
                 {/* Los datos de la fila */}
