      ...
      <html>
        <head>
          ...
          <style>
            ...
            body { font-family: 'Inter', system-ui, sans-serif; color: #000000; margin: 0; padding: 10px 40px 40px 40px; }
        ...
        <body>
          <div class="container">
            ...
            <div style="margin-top: 20px; text-align: center; font-size: 12px; color: #000000;">
