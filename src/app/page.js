...
export default function Home() {
  ...
  return (
    <div className="h-[100dvh] w-full relative bg-white sm:bg-slate-50 lg:bg-slate-100 overflow-hidden font-sans transition-colors duration-300">
      <Toaster position="bottom-center" />
      ...
      {/* LAYER 1: SCROLLING CONTENT (Hoja de Papel) */}
      ...
      {/* LAYER 2 & 3: GLASS AND HEADER (AHORA SON SIBLINGS DE LAYER 1) */}
      <div className="absolute inset-0 pointer-events-none z-10 hidden sm:flex flex-col">
          ...
          <div className="absolute top-0 left-0 w-full h-[100dvh] pointer-events-none flex flex-col z-10">
            ...
            <div className="flex-1 flex relative w-full">
              ...
              <div className="w-full sm:max-w-[520px] lg:max-w-[680px] mx-auto bg-transparent h-full px-0 shadow-[inset_0_0_20px_rgba(0,0,0,0.02)] relative pointer-events-none" />
